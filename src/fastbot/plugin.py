...
class Plugin:
    ...
    async def __call__(self, event: Event) -> None:
        await asyncio.gather(*(executor(event) for executor in self.commanders))
...
def on(
    ...
    def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        if any(
            ...
            or type_hints.get(param_name, param.annotation) is FastBot
            for param_name, param in sign.parameters.items()
        ):
